import { c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, a as subscribe, o as onDestroy, f as spread, g as escape_object, h as createEventDispatcher, i as each, v as validate_component } from "../../../chunks/index3.js";
import { m as modeCurrent, s as setInitialClassState } from "../../../chunks/ProgressBar.svelte_svelte_type_style_lang.js";
import { w as writable } from "../../../chunks/index2.js";
import { n as navItems, s as siteAuthor } from "../../../chunks/config.js";
/* empty css                   */import { c as courses } from "../../../chunks/stores2.js";
...
const NavItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<li class="dark:hover:text-primary-500 dark:active:text-primary-300 hover:text-primary-700 active:text-primary-500 transition duration-150 ease-linear"><a class="${["no-underline", isCurrentPage ? "active" : ""].join(" ").trim()}"${add_attribute("href", href, 0)}${add_attribute("aria-current", isCurrentPage ? "page" : false, 0)}>${slots.default ? slots.default({}) : ``}</a></li>`;
});
const MainNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { styles = "flex-row" } = $$props;
  let { ariaLabel = "" } = $$props;
  ...
  return `
<nav${add_attribute("aria-label", ariaLabel, 0)}><ul class="${"flex list-none " + escape(styles, true)}">${each(navItems, (page) => {
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer class="mx-4 mt-6"><section class="flex flex-col items-center"><img src="/images/sait-logo.png" alt="Sait Logo" class="w-16 mb-2">
    <nav class="mb-2"><ul class="flex gap-2 lg:gap-4 list-none">${each(navItems, (page) => {
    return `${validate_component(NavItem, "NavItem").$$render($$result, { href: page.route }, {}, {
      default: () => {
        return `${escape(page.title)}
          `;
  ...
  <section><div class="text-center my-2"><p>©${escape((/* @__PURE__ */ new Date()).getFullYear())} ${escape(siteAuthor)}</p></div>
    <ul class="flex justify-center gap-2 lg:gap-4 mb-4 list-none"><li><a href="https://codepen.io/acidtone" target="_blank" class="dark:hover:text-primary-500 dark:active:text-primary-300 hover:text-primary-700 active:text-primary-500 transition duration-150 ease-linear">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
    ...
    {}
      ...
      <li><a href="https://github.com/sait-wbdv" target="_blank" class="dark:hover:text-primary-500 dark:active:text-primary-300 hover:text-primary-700 active:text-primary-500 transition duration-150 ease-linear">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
    ...
    {}
      ...
      <li><a href="https://www.figma.com/team_invite/redeem/iied98q0sW8p9gSDqm1hML" target="_blank" class="dark:hover:text-primary-500 dark:active:text-primary-300 hover:text-primary-700 active:text-primary-500 transition duration-150 ease-linear">${validate_component(Icon, "Icon").$$render(
    $$result,
    {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_courses();
  return `${validate_component(AppShell, "AppShell").$$render($$result, { regionPage: "scroll-smooth" }, {}, {
    pageFooter: () => {
      return `${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}
  `;
    },
    sidebarLeft: () => {
      return `<nav class="ml-4 mr-8 hidden md:block md:mr-20 lg:mr-8 mt-6 lg:mt-12 p-2 lg:p-4 rounded-md"><h3 class="h3 ml-2">Courses</h3>
      <ul class="list">${each($courses, (course) => {
        return `<li><a href="${"/courses/" + escape(course.code, true)}" target="_self" class="p-2 hover:bg-primary-800/20 block rounded-md transition duration-150 ease-linear no-underline"><h4>${escape(course.codeLabel)}</h4>
              <p class="hidden xl:block w-48">${escape(course.title)}</p></a>
          </li>`;
      })}</ul></nav>
  `;
    },
    header: () => {
      return `${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        headline: () => {
          return `${validate_component(MainNav, "MainNav").$$render(
            $$result,
            {
              styles: "items-center flex-col lg:hidden hidden",
        ...
        trail: () => {
          return `<div class="flex justify-center items-center gap-4">${validate_component(MainNav, "MainNav").$$render($$result, { styles: "gap-4 hidden lg:flex" }, {}, {})}

          <div class="border-r-2 lg:border-none h-fit px-4 border-slate-400 flex gap-4 items-center">${validate_component(LightSwitch, "LightSwitch").$$render($$result, { rounded: "rounded-xl" }, {}, {})}
            <a href="https://github.com/sait-wbdv" target="_blank">${validate_component(Icon, "Icon").$$render(
            $$result,
            {
              icon: "fa6-brands:github",
              class: "text-xl dark:text-white text-black"
            },
            {},
            {}
          )}</a></div>
          <button class="lg:hidden hover:opacity-75 transition duration-150 ease-linear">${`${validate_component(Icon, "Icon").$$render($$result, { icon: "fa6-solid:bars" }, {}, {})}`}</button></div>
      `;
        },
        lead: () => {
