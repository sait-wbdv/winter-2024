...
<li>Have you ever designed a logo before?</li>
<li>Are there any logos (from anywhere) that you like?, why?</li></ol>
...
<p>We’ll work throught his together to practice creating shapes and conducting design “refactors”/cleanup. It’s important to be able to organize design files effectively to reduce bugs and conflicts in the process.</p>
<h3 id="basic-tool-tasks"><a aria-hidden="true" tabindex="-1" href="#basic-tool-tasks"><span class="icon icon-link"></span></a>Basic Tool Tasks</h3>
<ul><li>Draw horizontal and vertical lines (go in multiple directions)</li>
<li>Draw squares, rectangles, and other polyons</li>
<li>Draw circles and ovals</li>
<li>Label your different shapes</li></ul>
<h3 id="color-tool-tasks"><a aria-hidden="true" tabindex="-1" href="#color-tool-tasks"><span class="icon icon-link"></span></a>Color Tool Tasks</h3>
<ul><li>Add fill color</li>
<li>Add stroke color</li>
<li>Play with both on different shapes</li></ul>
<h3 id="complex-tool-tasks"><a aria-hidden="true" tabindex="-1" href="#complex-tool-tasks"><span class="icon icon-link"></span></a>Complex Tool Tasks</h3>
<ul><li>Run a union on two shapes</li>
<li>Run a subtract on two shapes</li></ul>
...
<li>Name all of the paths and group them logically<h2 id="logos-manual">Logo Design Practice</h2></li></ol>
