...
<p>Most of your time in this program will be spent in your code editor. </p>
<p>Code editors or IDEs(Integrated Developer Environments) come with features like syntax highlighting, code completion, and extensions that enhance the development workflow.</p>
<p>If you haven’t installed one yet, VS Code is the current industry favourite. </p>
<ul><li><a href="https://code.visualstudio.com/download" rel="nofollow">Install VS Code</a></li></ul>
<p>If you’ve been using one you like, you can stick with it! Your instructors will be using VS Code.</p>
...
<p>For more settings options, check out this link <a href="https://code.visualstudio.com/docs/getstarted/settings" rel="nofollow">https://code.visualstudio.com/docs/getstarted/settings</a></p>
...
<li><a href="https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode" rel="nofollow">Prettier</a></li>
<li><a href="https://marketplace.visualstudio.com/items?itemName=MS-vsliveshare.vsliveshare" rel="nofollow">Live Share</a></li></ul>
<hr>
<h2>Git</h2>
...
<li><em>Watch</em> and/or <em>Star</em> the <a href="https://github.com/sait-wbdv/winter-2024" rel="nofollow">program repository</a>.</li>
