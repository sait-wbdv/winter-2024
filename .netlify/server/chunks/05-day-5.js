...
<ul><li><a href="https://supabase.com/docs/guides/getting-started/quickstarts/sveltekit" rel="nofollow">instructions</a></li></ul>
...
<ul><li>The abovenoted instructions don’t include how to use environment variables<ul><li>these are essential for keeping your app securite</li>
<li>not using environment variables correctly leads to your api keys being publically accessible</li></ul></li>
<li><a href="https://joyofcode.xyz/sveltekit-environment-variables" rel="nofollow">dotenv instructions</a></li>
<li><a href="https://youtu.be/ai8PJgxF9Lw?si=-2uhWLVralDQiaCW" rel="nofollow">video instructions</a><ul><li>add a <code>.env</code> file and add your keys<ul><li><code>SECRET_SUPABASE_URL=al;dskjfaljal.supabase.co</code></li>
<li><code>SECRET_SUPABASE_ANON_KEY=as;dlkfjasdlfafewr.rotierjtsgn</code></li></ul></li>
<li>then import them into your <code>$lib/supabaseClient.js</code> file<pre class="language-undefined"><!-- HTML_TAG_START -->${`<code class="language-undefined">import &#123;SECRET_SUPABASE_URL, SECRET_SUPABASE_ANON_KEY&#125; from &quot;$env/static/private&quot;</code>`}<!-- HTML_TAG_END --></pre></li>
<li>then use them in the the export createClient</li>
</ul><pre class="language-undefined"><!-- HTML_TAG_START -->${`<code class="language-undefined">export const supabase = createClient(SECRET_SUPABASE_URL, SECRET_SUPABASE_ANON_KEY)</code>`}<!-- HTML_TAG_END --></pre></li></ul>
<hr>
...
<ul><li>notes are on the day 4 lesson plan</li>
<li>assign groups</li></ul>`;
    }
  })}
