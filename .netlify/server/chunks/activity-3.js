...
<h3 id="5-points-directus-configuration"><a aria-hidden="true" tabindex="-1" href="#5-points-directus-configuration"><span class="icon icon-link"></span></a>5 Points: Directus Configuration</h3>
<ul><li>Directus has been scaffolded locally</li>
<li>posts collection added</li>
<li>Access permissions are configured correctly</li>
<li>Directus install has been set up in git and pushed to github</li></ul>
<h3 id="5-points-supabase--sveltekit-configuration"><a aria-hidden="true" tabindex="-1" href="#5-points-supabase--sveltekit-configuration"><span class="icon icon-link"></span></a>5 Points Supabase + Sveltekit Configuration</h3>
<ul><li>All 3 platforms are connected to one another</li>
<li>Platforms are all set up according to up to date instructions</li>
<li>Supabase feeds the frontend data that has been created in Directus</li></ul>
...
<li><strong>IMPORTANT</strong>: in your zipped folder (but not in your repo) submit images of:<ul><li>your Directus setup running locally</li>
<li>Your collections settings screen</li>
<li>The post Data schema</li></ul></li>
<li>Also submit a read only link to your supabase endpoint and the api key (this should be in the text submission so that I can test the endpoint in postman)</li></ul>`;
});
export {
