...
const _10_day_10 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Homework, "Homework").$$render($$result, { status }, {}, {
    default: () => {
      return `<h2>Prep</h2>
<ul><li>Be prepared to do a run through of your presentation and demo</li>
<li>We will do 2 sets of run throughs, 1 in the morning on arrival, and then one at the end of the day</li></ul>`;
    }
  })}
